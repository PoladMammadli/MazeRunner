...
{
    public class MoveUpCommand : CommandBase
    {
        private readonly GameAreaViewModel _gameAreaViewModel;
        private readonly GameObject _gameObject;

        public MoveUpCommand(GameAreaViewModel gameAreaViewModel, GameObject gameObject)
        {
        ...
        public override void Execute(object parameter)
        {
            ...
            _gameObject.PlayerDirection = Direction.UpArrow;
